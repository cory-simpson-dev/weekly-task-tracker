...
router.post('/createTaskFromFavorite', tasksController.createTaskFromFavorite)
router.put('/addFavoriteTask', tasksController.addFavoriteTask)
router.put('/removeFavoriteTask', tasksController.removeFavoriteTask)
...
router.put('/resetTaskStatusAll', tasksController.resetTaskStatusAll)
router.put('/resetTaskStatus', tasksController.resetTaskStatus)
